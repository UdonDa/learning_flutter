...
class ExplorePage extends StatelessWidget {
  ...
  static String _popularSpotsTitleText = 'Travex !!';
  static String _nearMeTitleText = 'Near You!';
  static String _restaurantTitleText = 'Top Restaurants!';

  ExploreCard _popularSpotsCard = ExploreCard(itemList: popularSpots, titleText: _popularSpotsTitleText);
  ExploreCard _nearMeCard = ExploreCard(itemList: nearMe, titleText: _nearMeTitleText);
  ExploreCard _restaurantCard = ExploreCard(itemList: restaurantImgUrl, titleText: _restaurantTitleText);
